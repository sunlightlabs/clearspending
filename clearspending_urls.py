...
#    (r'^scorecard/program/(?P<program_id>\d+)/', 'metrics.views.get_program_detail'),
    ...
    url(r'^feedback/submitted/$', direct_to_template, {'template': 'contact_post'}, name="contact-post"),
    ...
    url(r'^contact/', direct_to_template, {'template': 'contact_us.html'}, name='contact-us'),
